...
export const texts = {
    es: {
        ...
        // About Experience
        present: 'actualidad',
        aemSitesPosition: 'Desarrollador Sites AEM',
        aemPosition: 'Desarrollador AEM',
        aemDetails: 'Desarrollo de cuadros de diálogos y componentes para AEM Sites en Java, HTL y React. Manejo del CRX. Creación de automatizaciones en Groovy y JavaScript.',
        aemDetails2: 'Desarrollo de bundles, mantenimiento de aplicaciones SpringBoot, configuración "Web console" para instancia enfocada en AEM Forms. Creación de automatizaciones en Python',
    ...
    en: {
        ...
        // About Experience
        present: 'present',
        aemSitesPosition: 'AEM Sites Developer',
        aemPosition: 'AEM Developer',
        aemDetails: 'Development of dialog boxes and components for AEM Sites in Java, HTL and React. Handling of CRX. Creation of automations in Groovy and JavaScript.',
        aemDetails2: 'Bundle development, SpringBoot application maintenance, web console configuration for AEM Forms focused instance. Creation of automations in Python.',
